...
class Scene():
    ...
    def get_intersection(self, ray):
        ...
        for object in self.objects:
            ...
            if check_restrictions(t0, closest_t):
                closest_t = t0
                closest_object = object
            
            if check_restrictions(t1, closest_t):
                closest_t = t1
                closest_object = object
    
    def check_restrictions(self, t, closest_t):
        return self.camera.t_min <= t0 <= self.camera.t_max and t0 < closest_t
